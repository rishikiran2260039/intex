...
@Component({
  selector: 'app-contract-manage-site',
  templateUrl: './contract-manage-site.component.html',
  styleUrls: ['./contract-manage-site.component.scss']
})
export class ContractManageSiteComponent implements OnInit {
  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public data: any, public dialog: MatDialog,public dialogRef:MatDialogRef<ContractManageSiteComponent>) { }
