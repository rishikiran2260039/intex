...
@Component({
  selector: 'app-unscheduled-contract',
  templateUrl: './unscheduled-contract.component.html',
  styleUrls: ['./unscheduled-contract.component.scss']
})
export class UnscheduledContractComponent implements OnInit {
