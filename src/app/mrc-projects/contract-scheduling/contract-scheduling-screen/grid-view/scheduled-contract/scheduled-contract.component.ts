...
@Component({
  selector: 'app-scheduled-contract',
  templateUrl: './scheduled-contract.component.html',
  styleUrls: ['./scheduled-contract.component.scss']
})
export class ScheduledContractComponent implements OnInit {
