  ...
  tableData() {
    if(this.week === 2) {
      this.items = [
        ...
        { UserName: 'Kenneth', SundayCount: '0.00', MondayCount: '14.00', TuesdayCount: '16.00', WednesdayCount: '16.00', ThrusdayCount: '16.00', FridayCount: '8.00', SaturdayCount: '0.00', TotalCount: '70.00' }, 
