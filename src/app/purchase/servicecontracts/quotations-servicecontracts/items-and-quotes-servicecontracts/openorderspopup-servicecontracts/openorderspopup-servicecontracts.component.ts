...
@Component({
  selector: 'app-openorderspopup-servicecontracts',
  templateUrl: './openorderspopup-servicecontracts.component.html',
  styleUrls: ['./openorderspopup-servicecontracts.component.scss']
})
export class OpenorderspopupServicecontractsComponent implements OnInit {

  constructor(public dialog : MatDialogRef< OpenorderspopupServicecontractsComponent >,) { }
  ngOnInit() {
  }
