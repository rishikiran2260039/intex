...
@Component({
  selector: 'app-workorders-terms',
  templateUrl: './workorders-terms.component.html',
  styleUrls: ['./workorders-terms.component.scss']
})
export class WorkordersTermsComponent implements OnInit {
