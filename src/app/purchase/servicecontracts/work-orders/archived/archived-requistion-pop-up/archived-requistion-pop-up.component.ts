...
@Component({
  selector: 'app-archived-requistion-pop-up',
  templateUrl: './archived-requistion-pop-up.component.html',
  styleUrls: ['./archived-requistion-pop-up.component.scss']
})
export class ArchivedRequistionPopUpComponent implements OnInit {

  constructor(public dialog:MatDialogRef<ArchivedRequistionPopUpComponent>) { } 
  ngOnInit() { } 
  items = [ 
