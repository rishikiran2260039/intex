...
@Component({
  selector: 'app-equipment-service-challans-pop-up',
  templateUrl: './equipment-service-challans-pop-up.component.html',
  styleUrls: ['./equipment-service-challans-pop-up.component.scss']
})
export class EquipmentServiceChallansPopUpComponent implements OnInit {
