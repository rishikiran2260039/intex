...
export class ItemsPublishPopupComponent implements OnInit {
  ...
  constructor(public dialog:MatDialogRef<ItemsPublishPopupComponent>) { } ngOnInit() { }   items = [ {AvailQty:"70",OrderQty: "30",ReqRef: "OM/REQ/SPA-FEB-19/1057	",Qty:10,  ItemName : "Planter Boxes", ItemCode: "TBCS", RequisitionRef: "OM/REQ/SPA-FEB-19/1057	",RequiredQty:"50",DeliveryDate:"21-07-2021",unitprice:"200" }, 
