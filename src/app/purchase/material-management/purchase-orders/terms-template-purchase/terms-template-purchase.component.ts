...
import { NarrationsPurchasePopupComponent } from './narrations-purchase-popup/narrations-purchase-popup.component';
import { SavenewtemplatePurchasePopupComponent } from './savenewtemplate-purchase-popup/savenewtemplate-purchase-popup.component';

@Component({
  selector: 'app-terms-template-purchase',
  templateUrl: './terms-template-purchase.component.html',
  styleUrls: ['./terms-template-purchase.component.scss']
})
export class TermsTemplatePurchaseComponent implements OnInit {
