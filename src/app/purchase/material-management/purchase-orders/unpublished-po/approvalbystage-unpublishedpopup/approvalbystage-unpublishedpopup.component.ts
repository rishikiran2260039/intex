...
@Component({
  selector: 'app-approvalbystage-unpublishedpopup',
  templateUrl: './approvalbystage-unpublishedpopup.component.html',
  styleUrls: ['./approvalbystage-unpublishedpopup.component.scss']
})
export class ApprovalbystageUnpublishedpopupComponent implements OnInit {

  constructor(public dialog:MatDialogRef< ApprovalbystageUnpublishedpopupComponent>) { }
