...
@Component({
  selector: 'app-items-popup-active',
  templateUrl: './items-popup-active.component.html',
  styleUrls: ['./items-popup-active.component.scss']
})
export class ItemsPopupActiveComponent implements OnInit {
  constructor(public dialog:MatDialogRef<ItemsPopupActiveComponent>) { }
