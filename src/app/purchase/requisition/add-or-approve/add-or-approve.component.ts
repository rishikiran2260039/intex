...
@Component({
  selector: 'app-add-or-approve',
  templateUrl: './add-or-approve.component.html',
  styleUrls: ['./add-or-approve.component.scss']
})
export class AddOrApproveComponent implements OnInit {
