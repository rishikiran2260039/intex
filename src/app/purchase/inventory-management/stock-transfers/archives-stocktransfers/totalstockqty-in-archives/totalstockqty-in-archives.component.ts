...
@Component({
  selector: 'app-totalstockqty-in-archives',
  templateUrl: './totalstockqty-in-archives.component.html',
  styleUrls: ['./totalstockqty-in-archives.component.scss']
})
export class TotalstockqtyInArchivesComponent implements OnInit {

  constructor(public dialog : MatDialogRef<TotalstockqtyInArchivesComponent>) { }
  filterToggle = false;
