...
@Component({
  selector: 'app-surplusstockdialog',
  templateUrl: './surplusstockdialog.component.html',
  styleUrls: ['./surplusstockdialog.component.scss']
})
export class SurplusstockdialogComponent implements OnInit {

  
  constructor(public dialog : MatDialogRef<SurplusstockdialogComponent>) { }
  filterToggle = false;
