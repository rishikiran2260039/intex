...
export class EditUserComponent implements OnInit {
  ...
  constructor(public _rolesService: RolesService, public fb: FormBuilder,private userService: UsersService, public dialogRef: MatDialogRef<EditUserComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
