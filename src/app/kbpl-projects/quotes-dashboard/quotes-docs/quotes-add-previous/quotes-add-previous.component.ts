...
@Component({
  selector: 'app-quotes-add-previous',
  templateUrl: './quotes-add-previous.component.html',
  styleUrls: ['./quotes-add-previous.component.scss']
})
export class QuotesAddPreviousComponent implements OnInit {

  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public project: any ,public dialogRef: MatDialogRef<QuotesAddPreviousComponent>) { 
