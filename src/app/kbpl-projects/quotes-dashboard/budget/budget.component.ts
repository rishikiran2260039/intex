...
import { QuotesAddSowComponent } from './quotes-add-sow/quotes-add-sow.component';
import { QuotesAddSiteComponent } from './quotes-add-site/quotes-add-site.component';
import { AddTaskComponent } from './add-task/add-task.component';
import { QuotesUpdateBudgetComponent } from './quotes-update-budget/quotes-update-budget.component';
import { ManaSiteComponent } from '../../newproject-dashboard/project-budget/mana-site/mana-site.component';
...
export class BudgetComponent implements OnInit {
  ...
  editBudget(){
    let dialogRef = this.dialog.open(QuotesUpdateBudgetComponent, {
      data: false,
      height: 'auto',
      width: '1055px',
      disableClose: true
...
items = [
  ...
  openAddContractDialog() {
    let dialogRef = this.dialog.open(QuotesAddSowComponent, {
      data: false,
      height: 'auto',
      width: '1055px',
      disableClose: true
  ...
  public openSiteDailog() {
    let dialogRef = this.dialog.open(QuotesAddSiteComponent, {
      data: false,
      height: 'auto',
      width: '1055px',
      disableClose: true
  ...
  public openEditSite() {
    let dialogRef = this.dialog.open(ManageSiteComponent, {
      height: 'auto',
      width: '500px'
    });
    dialogRef.afterClosed().subscribe(data => {
