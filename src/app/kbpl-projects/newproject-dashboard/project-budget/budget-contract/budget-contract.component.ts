...
@Component({
  selector: 'app-budget-contract',
  templateUrl: './budget-contract.component.html',
  styleUrls: ['./budget-contract.component.scss']
})
export class BudgetContractComponent implements OnInit {
