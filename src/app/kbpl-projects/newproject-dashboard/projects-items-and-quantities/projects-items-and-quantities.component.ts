...
import { ProjectsadddialogComponent } from './projectsadddialog/projectsadddialog.component';
import { ProjectsgriddialogComponent } from './projectsgriddialog/projectsgriddialog.component';

@Component({
  selector: 'app-projects-items-and-quantities',
  templateUrl: './projects-items-and-quantities.component.html',
  styleUrls: ['./projects-items-and-quantities.component.scss']
})
export class ProjectsItemsAndQuantitiesComponent implements OnInit {
  ...
  public addnewitem(item) {
    let dialogRef = this.dialog.open( ProjectsadddialogComponent, {
      data:item,
      height: 'auto',
      width: '700px'
    });
  ...
  public openGridColumnsDialog() {
    let dialogRef = this.dialog.open(ProjectsgriddialogComponent, {
