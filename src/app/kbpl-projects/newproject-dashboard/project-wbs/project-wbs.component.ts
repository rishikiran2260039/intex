...
import { AddTaskWbsComponent } from './add-task-wbs/add-task-wbs.component';
import { EditProjectWBSComponent } from './edit-project-wbs/edit-project-wbs.component';
import { EditTask1Component } from './edit-task/edit-task.component';

@Component({
  selector: 'app-project-wbs',
  templateUrl: './project-wbs.component.html',
  styleUrls: ['./project-wbs.component.scss']
})
export class ProjectWBSComponent implements OnInit {
 ...
 public autoScale = true; 
  ...
  public openTaskDailog() {
    let dialogRef = this.dialog.open(AddTaskWbsComponent, {
      data: false,
      height: 'auto',
      width: '700px',
      disableClose: true
  ...
  public editTaskDailog() {
    let dialogRef = this.dialog.open(EditTask1Component , {
      data: false,
      height: 'auto',
      width: '700px',
      disableClose: true
  ...
  editWBS(){
    let dialogRef = this.dialog.open(EditProjectWBSComponent, {
      width:"1055px",
      height:'auto'
    })
  }
