...
import { pAddCategoryComponent } from '../project-boq/add-category/add-category.component';
import { pUploadBoqComponent } from '../project-boq/upload-boq/upload-boq.component';

@Component({
  selector: 'app-project-deviation',
  templateUrl: './project-deviation.component.html',
  styleUrls: ['./project-deviation.component.scss']
})
export class ProjectDeviationComponent implements OnInit {
