...
import { ProjectAddPartsComponent } from '../project-add-parts/project-add-parts.component';



@Component({
  selector: 'app-service-challans-parts',
  templateUrl: './service-challans-parts.component.html',
  styleUrls: ['./service-challans-parts.component.scss']
})
export class ServiceChallansPartsComponent implements OnInit {
  ...
  addparts(){
    this.dialog.open(ProjectAddPartsComponent,{
      height:'auto',
      width:'740px'
    })
