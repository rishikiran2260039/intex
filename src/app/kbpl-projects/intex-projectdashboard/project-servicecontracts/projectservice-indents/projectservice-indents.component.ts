...
import { AddIndentComponent } from './add-indent/add-indent.component';

@Component({
  selector: 'app-projectservice-indents',
  templateUrl: './projectservice-indents.component.html',
  styleUrls: ['./projectservice-indents.component.scss']
})
export class ProjectserviceIndentsComponent implements OnInit {
  ...
  public addrequisition(item) {
    let dialogRef = this.dialog.open(AddIndentComponent, {
      data:item,
      height: 'auto',
      width: '800px'
    });
