...
@Component({
  selector: 'app-consignpurchasemodal',
  templateUrl: './consignpurchasemodal.component.html',
  styleUrls: ['./consignpurchasemodal.component.scss']
})
export class ConsignpurchasemodalComponent implements OnInit {
  constructor(public dialog : MatDialogRef<ConsignpurchasemodalComponent>,) { }
  ngOnInit() {
  }
