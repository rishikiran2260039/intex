...
@Component({
  selector: 'app-view-invoicing',
  templateUrl: './view-invoicing.component.html',
  styleUrls: ['./view-invoicing.component.scss']
})
export class ViewInvoicingComponent implements OnInit {
