...
export const routes = [
  ...
  { path: 'scheduling-grid-view', component: ActionGridViewComponent, loadChildren: './action-grid-view/action-grid-view.module#ActionGridViewModule', data: { breadcrumb: 'Projects' } },
  { path: 'scheduling-board-view', component: ActionBoardViewComponent, data: { breadcrumb: 'Projects' } },
  { path: 'scheduling-summary-view', redirectTo: 'scheduling-summary-view/1/2', pathMatch: 'full' },
  { path: 'scheduling-summary-view/:view/:week', component: ActionSummaryViewComponent, data: { breadcrumb: 'Projects' } },
]
