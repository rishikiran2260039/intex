...
import { QtyUpdateComponent } from './qty-update/qty-update.component';
...
export class QalogArnComponent implements OnInit {
  ...
  // addQtyUpdatePopup(){
  //   this.dialog.open(QtyUpdateComponent, {
  //     height:'auto',
  //      width:'700px'
  //    })
  // }
  public addQtyUpdatePopup(item) {
    let dialogRef = this.dialog.open(QtyUpdateComponent, {
      data:item,
      height: 'auto',
      width: '800px'
    });
